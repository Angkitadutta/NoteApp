...
class NoteRVAdapter(
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val noteTitle = itemView.findViewById<TextView>(R.id.tvNoteTitle)
        val noteTimeStamp = itemView.findViewById<TextView>(R.id.tvDate)
        val noteDelete = itemView.findViewById<ImageView>(R.id.ivDelete)
    }
}
